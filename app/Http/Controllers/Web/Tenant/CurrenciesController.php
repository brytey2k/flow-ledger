...
class CurrenciesController extends Controller
{
    ...
    public function index(IndexFilterRequest $request): View
    {
        ...
        $currencies = $this->repository->allOrderedByShortName($filters);
    ...
    public function store(CurrencyStoreRequest $request): RedirectResponse
    {
        ...
        return redirect()
            ...
            ->with('success', __('flash.currencies.created'));
    }
    ...
    public function update(CurrencyUpdateRequest $request, Currency $currency): RedirectResponse
    {
        ...
        return redirect()
            ->route('currencies.index')
            ->with('success', __('flash.currencies.updated'));
    }
    ...
    public function destroy(Currency $currency): RedirectResponse
    {
        ...
        return redirect()
            ->route('currencies.index')
            ->with('success', __('flash.currencies.deleted'));
    }
}
