...
<div x-cloak class="sgh-sidebar fixed bottom-0 top-0 z-20 shrink-0 flex-col items-stretch border-e border-e-border bg-background pt-3 lg:flex"
    :class="{ 'hidden': !$store.sidebarDrawer.open, 'flex': $store.sidebarDrawer.open, 'is-hover-expanded': collapsed && hovering }"
