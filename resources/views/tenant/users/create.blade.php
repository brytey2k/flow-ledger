                ...
                <form method="POST" action="{{ route('users.store') }}" class="grid gap-7">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input id="password" name="password" type="password" class="fl-input w-full" required aria-invalid="@error('password') true @else false @enderror" />
                            @error('password')
                                <p class="mt-1 text-sm text-destructive">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input id="password_confirmation" name="password_confirmation" type="password" class="fl-input w-full" required />
                        </div>
