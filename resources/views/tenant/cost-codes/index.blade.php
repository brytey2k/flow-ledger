    ...
    <div class="grid gap-5 lg:gap-7.5">
        <div class="kt-card kt-card-grid">
            <div class="kt-card-header">
                <h3 class="kt-card-title">{{ __('cost_codes.all') }}</h3>
                        ...
                        <table class="kt-table kt-table-border">
                            ...
                            <tbody>
                                @foreach($costCodes as $costCode)
                                    <tr>
                                        <td>
                                            <span class="kt-badge kt-badge-sm kt-badge-primary">{{ $costCode->id }}</span>
                                        </td>
                                        <td>
                                            <span class="kt-badge kt-badge-sm kt-badge-outline font-mono">{{ $costCode->code }}</span>
                                        </td>
                                        <td>
