    ...
    <form method="POST" action="{{ route('settings.update') }}" enctype="multipart/form-data" class="grid gap-5 lg:gap-7.5">
        ...
        <div class="sgh-card">
            <div class="sgh-card-header">
                <h3 class="sgh-card-title">{{ __('settings.branding_card') }}</h3>
            </div>
            <div class="sgh-card-content">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    {{-- Light mode logo --}}
                    <div>
                        <label class="sgh-form-label block mb-2" for="logo_light">
                        ...
                        @if($lightLogoUrl)
                            <div class="mb-3 flex items-center gap-4">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <label for="remove_logo_light" class="sgh-form-label mb-0 text-sm text-destructive">
                    ...
                    {{-- Dark mode logo --}}
                    <div>
                        <label class="sgh-form-label block mb-2" for="logo_dark">
                        ...
                        @if($darkLogoUrl)
                            <div class="mb-3 flex items-center gap-4">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <label for="remove_logo_dark" class="sgh-form-label mb-0 text-sm text-destructive">
                    ...
                    <div>
                        <label class="sgh-form-label block mb-2" for="logo_small">
                        ...
                        @if($smallLogoUrl)
                            <div class="mb-3 flex items-center gap-4">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <label for="remove_logo_small" class="sgh-form-label mb-0 text-sm text-destructive">
        ...
        <div class="sgh-card">
            <div class="sgh-card-header">
                <h3 class="sgh-card-title">{{ __('settings.advance_defaults_card') }}</h3>
            </div>
            <div class="sgh-card-content">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    <div>
                        <label class="sgh-form-label block mb-2" for="default_advance_cost_code_id">
        ...
        <div class="sgh-card">
            <div class="sgh-card-header">
                <h3 class="sgh-card-title">{{ __('settings.expense_settings_card') }}</h3>
            </div>
            <div class="sgh-card-content">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <label class="sgh-form-label mb-0" for="require_expense_source_documents">
        ...
        <div class="sgh-card">
            <div class="sgh-card-header">
                <h3 class="sgh-card-title">{{ __('settings.retirement_settings_card') }}</h3>
            </div>
            <div class="sgh-card-content">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <label class="sgh-form-label mb-0" for="require_retirement_source_documents">
        ...
        <div class="sgh-card">
            <div class="sgh-card-header">
                <h3 class="sgh-card-title">{{ __('settings.retirement_reminders_card') }}</h3>
            </div>
            <div class="sgh-card-content">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    {{-- Grace period --}}
                    <div>
                        <label class="sgh-form-label block mb-2" for="retirement_reminder_grace_period_days">
                    ...
                    {{-- Frequency --}}
                    <div>
                        <label class="sgh-form-label block mb-2" for="retirement_reminder_frequency_days">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <label class="sgh-form-label mb-0" for="retirement_reminder_notify_submitter">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <label class="sgh-form-label mb-0" for="retirement_reminder_notify_approvers">
                        ...
                        <div class="flex flex-wrap gap-4">
                            @foreach($roles as $role)
                                <div class="flex items-center gap-2">
                                    ...
                                    <label for="retirement_reminder_role_{{ $role->id }}" class="sgh-form-label mb-0 text-sm">
                                        {{ $role->name }}
                                    </label>
                                </div>
                            @endforeach
        ...
        <div class="sgh-card">
            <div class="sgh-card-header">
                <h3 class="sgh-card-title">{{ __('settings.sso_card') }}</h3>
            </div>
            <div class="sgh-card-content">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    <div>
                        <label class="sgh-form-label block mb-2" for="sso_default_branch_id">
                    ...
                    <div>
                        <label class="sgh-form-label block mb-2" for="sso_staff_role_name">
