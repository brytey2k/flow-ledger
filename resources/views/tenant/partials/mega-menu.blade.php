        ...
        <div class="hidden [--kt-drawer-enable:true] lg:flex lg:items-stretch lg:[--kt-drawer-enable:false]"
            ...
            <div class="kt-menu flex-col gap-5 lg:flex-row lg:gap-7.5" data-kt-menu="true" id="mega_menu">
                ...
                <div class="kt-menu-item" data-kt-menu-item-offset="0,0|lg:-20px, 0"
                    ...
                    <div class="kt-menu-link kt-menu-link-hover:text-primary kt-menu-item-active:text-mono kt-menu-item-show:text-primary kt-menu-item-here:text-mono kt-menu-item-active:font-semibold kt-menu-item-here:font-semibold text-sm font-medium text-secondary-foreground">
