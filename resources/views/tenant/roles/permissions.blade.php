...
<div class="fl-container-fixed">
    <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
        ...
        <div class="flex items-center gap-2.5">
            <a class="fl-btn fl-btn-outline" href="{{ route('roles.edit', $role) }}">
                <x-tabler-arrow-left />
    ...
    <div class="grid gap-5 lg:gap-7.5">
        <div class="fl-card">
            <div class="fl-card-header">
                <h3 class="fl-card-title">{{ __('roles.permissions.card') }}</h3>
            </div>
            <div class="fl-card-content">
                <form method="POST" action="{{ route('roles.permissions.update', $role) }}" class="grid gap-7">
                    ...
                    <div class="pt-5 mt-2 flex justify-start items-center gap-2.5 border-t">
                        ...
                        <a class="fl-btn fl-btn-light" href="{{ route('roles.edit', $role) }}">{{ __('common.cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
