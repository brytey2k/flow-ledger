...
<div class="kt-container-fixed">
    <div class="flex flex-wrap items-center justify-between gap-5 pb-7.5 lg:items-end">
        <div class="flex flex-col justify-center gap-2">
            <h1 class="text-xl font-medium leading-none text-mono">Roles Management</h1>
    ...
    <div class="grid gap-5 lg:gap-7.5">
        <div class="kt-card kt-card-grid">
            <div class="kt-card-header">
                <h3 class="kt-card-title">All Roles</h3>
            ...
            @if($roles->isEmpty())
                <div class="kt-card-content flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
                    <div class="flex flex-col items-center justify-center py-12">
                        ...
                        <p class="text-sm text-secondary-foreground mb-4">Get started by creating your first role</p>
                        @can(\App\Enums\Tenant\PermissionKey::CreateRole->value)
                                ...
                                <tr>
                                    <th class="min-w-[200px]">
                                        <span class="kt-table-col">
                                            <span class="kt-table-col-label">Role Name</span>
                                        ...
                                        <td class="text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                @can(\App\Enums\Tenant\PermissionKey::AccessRoles->value)
                                                    <a href="{{ route('roles.edit', $role) }}" class="kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost text-primary" title="Edit">
