    ...
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <div class="fl-card fl-card-grid">
            <div class="fl-card-header">
                <h3 class="fl-card-title">{{ __('disbursements.pending_card') }}</h3>
                        ...
                        <table class="fl-table fl-table-border">
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[140px]"><span class="fl-table-col"><span class="fl-table-col-label">{{ __('common.columns.amount') }}</span></span></th>
                                    <th class="min-w-[130px]"><span class="fl-table-col"><span class="fl-table-col-label">{{ __('disbursements.columns.approved') }}</span></span></th>
