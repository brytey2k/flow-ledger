    ...
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <div class="sgh-card sgh-card-grid">
            <div class="sgh-card-header">
                <h3 class="sgh-card-title">Cash Counts</h3>
                <span class="sgh-badge sgh-badge-sm sgh-badge-outline">{{ $totalCounts }} records</span>
            </div>
                        ...
                        <table class="sgh-table sgh-table-border">
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[100px]"><span class="sgh-table-col"><span class="sgh-table-col-label">Currency</span></span></th>
                                    <th class="min-w-[150px]"><span class="sgh-table-col"><span class="sgh-table-col-label">Counted At</span></span></th>
                                    <th class="min-w-[140px]"><span class="sgh-table-col"><span class="sgh-table-col-label">Counted By</span></span></th>
                                    <th class="min-w-[130px]"><span class="sgh-table-col"><span class="sgh-table-col-label">Book Balance</span></span></th>
                                    <th class="min-w-[130px]"><span class="sgh-table-col"><span class="sgh-table-col-label">Counted Total</span></span></th>
                                    <th class="min-w-[120px]"><span class="sgh-table-col"><span class="sgh-table-col-label">Difference</span></span></th>
                                    <th class="min-w-[100px]"><span class="sgh-table-col"><span class="sgh-table-col-label">Status</span></span></th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($rows as $count)
                                    @php
                                        ...
                                        $statusClass = match($status) {
                                            'surplus'  => 'sgh-badge-success',
                                            'deficit'  => 'sgh-badge-danger',
                                            default    => 'sgh-badge-neutral',
                                        };
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="sgh-badge sgh-badge-sm {{ $statusClass }}">{{ ucfirst($status) }}</span>
                                        </td>
                                        <td>
                                            @if($count->cashbook?->branch)
                                                <a href="{{ route('cash-count.show', [$count->cashbook->branch, $count]) }}" class="sgh-btn sgh-btn-xs sgh-btn-light">
