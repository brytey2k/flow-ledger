    ...
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <div class="fl-card p-5">
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <select name="action" class="fl-select fl-select-sm">
        ...
        <div class="fl-card fl-card-grid">
            <div class="fl-card-header">
                <h3 class="fl-card-title">Workflow Actions</h3>
                <span class="fl-badge fl-badge-sm fl-badge-outline">{{ $actions->total() }} records</span>
            </div>
                        ...
                        <table class="fl-table fl-table-border">
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[150px]"><span class="fl-table-col"><span class="fl-table-col-label">Actioned By</span></span></th>
                                    <th class="min-w-[110px]"><span class="fl-table-col"><span class="fl-table-col-label">Action</span></span></th>
                                    <th class="min-w-[220px]"><span class="fl-table-col"><span class="fl-table-col-label">Comment</span></span></th>
                                    <th class="min-w-[140px]"><span class="fl-table-col"><span class="fl-table-col-label">Date &amp; Time</span></span></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($actions as $wfAction)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fl-badge fl-badge-sm {{ $actionColors[$wfAction->action] ?? 'fl-badge-outline' }}">
