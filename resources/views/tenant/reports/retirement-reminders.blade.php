    ...
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div class="sgh-card p-5">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <span class="sgh-badge sgh-badge-sm sgh-badge-warning">Overdue</span>
                </div>
            ...
            <div class="sgh-card p-5">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <span class="sgh-badge sgh-badge-sm sgh-badge-outline">Count</span>
                </div>
            ...
            <div class="sgh-card p-5">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <span class="sgh-badge sgh-badge-sm sgh-badge-danger">Amount</span>
                </div>
        ...
        <div class="sgh-card sgh-card-grid">
            <div class="sgh-card-header">
                <h3 class="sgh-card-title">Retirement Reminder Log</h3>
                <span class="sgh-badge sgh-badge-sm sgh-badge-outline">{{ $rows->count() }} advances</span>
            </div>
                        ...
                        <table class="sgh-table sgh-table-border">
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[110px]"><span class="sgh-table-col"><span class="sgh-table-col-label">Days Overdue</span></span></th>
                                    <th class="min-w-[130px]"><span class="sgh-table-col"><span class="sgh-table-col-label">Reminders Sent</span></span></th>
                                    <th class="min-w-[130px]"><span class="sgh-table-col"><span class="sgh-table-col-label">Last Reminder</span></span></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($rows as $row)
                                    @php
                                        ...
                                        $urgencyColor = match(true) {
                                            $daysOverdue > 60 => 'sgh-badge-danger',
                                            $daysOverdue > 30 => 'sgh-badge-warning',
                                            default => 'sgh-badge-outline',
                                        };
                                    @endphp
                                    <tr>
                                        ...
                                        <td>
                                            <span class="sgh-badge sgh-badge-sm {{ $urgencyColor }}">{{ $daysOverdue }} days</span>
                                        </td>
                                        <td>
                                            <span class="sgh-badge sgh-badge-sm sgh-badge-primary">{{ $row->reminder_count }}</span>
                                        </td>
