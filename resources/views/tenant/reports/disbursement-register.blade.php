    ...
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <div class="fl-card p-5">
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <select name="method" class="fl-select fl-select-sm">
        ...
        <div class="fl-card fl-card-grid">
            <div class="fl-card-header">
                <h3 class="fl-card-title">Disbursements</h3>
                <span class="fl-badge fl-badge-sm fl-badge-outline">{{ $disbursements->total() }} records</span>
            </div>
                        ...
                        <table class="fl-table fl-table-border">
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[120px]"><span class="fl-table-col"><span class="fl-table-col-label">Branch</span></span></th>
                                    ...
                                    <th class="min-w-[120px]"><span class="fl-table-col"><span class="fl-table-col-label">Method</span></span></th>
                                    <th class="min-w-[140px]"><span class="fl-table-col"><span class="fl-table-col-label">Reference</span></span></th>
                                    <th class="min-w-[130px]"><span class="fl-table-col"><span class="fl-table-col-label">Disbursed By</span></span></th>
                            ...
                            <tbody>
                                @foreach($disbursements as $req)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fl-badge fl-badge-sm {{ $req->type === 'advance' ? 'fl-badge-primary' : 'fl-badge-warning' }}">
                                                {{ ucfirst($req->type) }}
                                            </span>
                                        </td>
