    ...
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <div>
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                ...
                <a href="{{ route('reports.expenditure-summary') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                ...
                <a href="{{ route('reports.outstanding-advances') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('reports.cash-position') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('reports.disbursement-register') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('reports.retirement-reminders') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-warning/10">
                ...
                <a href="{{ route('reports.retirement-variance') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-success/10">
                ...
                <a href="{{ route('reports.cash-count') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-primary/10">
        ...
        <div>
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                ...
                <a href="{{ route('reports.approval-turnaround') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-primary/10">
                ...
                <a href="{{ route('reports.pending-requests-aging') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-warning/10">
                ...
                <a href="{{ route('reports.send-back-rate') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4">
                ...
                <a href="{{ route('reports.audit-trail') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('reports.requests-by-status') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-info/10">
                ...
                <a href="{{ route('reports.denied-cancelled') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-danger/10">
                ...
                <a href="{{ route('reports.retirement-turnaround') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-primary/10">
                            <x-tabler-repeat class="text-xl text-primary" />
                        </div>
        ...
        <div>
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                ...
                <a href="{{ route('reports.workflow-sla') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-success/10">
                ...
                <a href="{{ route('reports.spend-trend') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-primary/10">
                ...
                <a href="{{ route('reports.top-spenders') }}" class="sgh-card sgh-card-hover p-5 flex flex-col gap-3 transition-shadow hover:shadow-md">
                    <div class="flex items-center gap-3">
                        <div class="flex size-10 items-center justify-center rounded-lg bg-warning/10">
