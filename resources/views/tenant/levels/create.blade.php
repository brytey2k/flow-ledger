...
<div class="sgh-container-fixed">
    <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
        ...
        <div class="flex items-center gap-2.5">
            <a class="sgh-btn sgh-btn-outline" href="{{ route('levels.index') }}">
                <x-tabler-arrow-left />
                {{ __('levels.back') }}
            </a>
        </div>
    ...
    <div class="grid gap-5 lg:gap-7.5">
        <div class="sgh-card">
            <div class="sgh-card-header">
                <h3 class="sgh-card-title">{{ __('levels.details_card') }}</h3>
            </div>
            <div class="sgh-card-content">
                <form method="POST" action="{{ route('levels.store') }}" class="grid gap-7">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                        <div class="col-span-1 lg:col-span-1">
                            ...
                            <input id="name" name="name" type="text" value="{{ old('name') }}"
                                   class="sgh-input w-full" placeholder="e.g. Regional Office" required
                        ...
                        <div class="col-span-1 lg:col-span-1">
                            <label class="sgh-form-label block mb-2" for="position">
                            ...
                            <input id="position" name="position" type="number" min="1"
                                   ...
                                   class="sgh-input w-full" placeholder="e.g. 1" required
                    ...
                    <div class="pt-5 mt-2 flex justify-start items-center gap-2.5">
                        ...
                        <a class="sgh-btn sgh-btn-light" href="{{ route('levels.index') }}">{{ __('common.cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
