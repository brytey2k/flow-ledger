...
<div class="sgh-container-fixed">
    @if($descendantsCount > 0)
        <div class="sgh-alert sgh-alert-light sgh-alert-warning mb-5">
            <span class="sgh-alert-icon"><x-tabler-info-square-rounded-filled class="text-xl" /></span>
            <div class="sgh-alert-content">
                <h4 class="sgh-alert-title">{{ __('branches.descendants_warning') }}</h4>
                <div class="sgh-alert-description">
