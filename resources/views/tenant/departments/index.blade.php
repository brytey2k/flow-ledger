    ...
    <div class="flex flex-wrap items-center justify-between gap-5 pb-7.5 lg:items-end">
        ...
        <div class="flex flex-wrap items-center gap-2.5">
            @can(App\Enums\Tenant\PermissionKey::CreateDepartment->value)
                <a class="fl-btn fl-btn-outline" href="{{ route('departments.import') }}">
                    <x-tabler-file-arrow-left />
                    {{ __('departments.import') }}
                </a>
                <a class="fl-btn fl-btn-primary" href="{{ route('departments.create') }}">
    ...
    <div class="grid gap-5 lg:gap-7.5">
        <div class="fl-card fl-card-grid">
            <div class="fl-card-header">
                <h3 class="fl-card-title">{{ __('departments.all') }}</h3>
                    ...
                    <div class="flex flex-col items-center justify-center py-12">
                        ...
                        @can(App\Enums\Tenant\PermissionKey::CreateDepartment->value)
                            <div class="flex flex-wrap items-center justify-center gap-2">
                                <a href="{{ route('departments.import') }}" class="fl-btn fl-btn-outline">
                                    <x-tabler-file-arrow-left />
                                    {{ __('departments.import') }}
                                </a>
                                <a href="{{ route('departments.create') }}" class="fl-btn fl-btn-primary">
                                    <x-tabler-plus-filled />
                        ...
                        <table class="fl-table fl-table-border">
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[200px]">
                                        <span class="fl-table-col">
                                            <span class="fl-table-col-label">{{ __('departments.fields.name') }}</span>
                                        </span>
                                    </th>
                            ...
                            <tbody>
                                @foreach($departments as $department)
                                    <tr>
                                        <td>
                                            <span class="fl-badge fl-badge-sm fl-badge-primary">{{ $department->id }}</span>
                                        </td>
                                        <td>
