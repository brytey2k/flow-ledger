...
<div class="kt-container-fixed">
    <div class="flex flex-wrap items-center justify-between gap-5 pb-7.5 lg:items-end">
        <div class="flex flex-col justify-center gap-2">
            <h1 class="text-xl font-medium leading-none text-mono">Currencies Management</h1>
            <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                Manage currencies used across the system
            </div>
        </div>
    ...
    <div class="grid gap-5 lg:gap-7.5">
        <div class="kt-card kt-card-grid">
            <div class="kt-card-header">
                <h3 class="kt-card-title">All Currencies</h3>
            ...
            @if($currencies->isEmpty())
                <div class="kt-card-content flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
                    <div class="flex flex-col items-center justify-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-foreground mb-2">No currencies found</h3>
                        <p class="text-sm text-secondary-foreground mb-4">Get started by creating your first currency</p>
                        @can(\App\Enums\Tenant\PermissionKey::CreateCurrency->value)
                                        ...
                                        <td class="text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                @can(\App\Enums\Tenant\PermissionKey::AccessCurrencies->value)
                                                    <a href="{{ route('currencies.edit', $currency) }}" class="kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost text-primary" title="Edit">
                                                        <i class="ki-filled ki-notepad-edit text-lg"></i>
                                                    </a>
                                                @endcan
                                                @can(\App\Enums\Tenant\PermissionKey::DeleteCurrency->value)
                                                    <form action="{{ route('currencies.destroy', $currency) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this currency?');" class="inline">
                                                        @csrf
                                                        @method('DELETE')
