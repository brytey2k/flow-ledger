...
@php
    ...
    $typeColors = [
        ...
        \App\Enums\Tenant\PaymentRequestType::Retirement->value => 'sgh-badge-success',
    ];
@endphp
                        ...
                        <table class="sgh-table sgh-table-border">
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[130px]"><span class="sgh-table-col"><span class="sgh-table-col-label">{{ __('common.columns.stage') }}</span></span></th>
                                    <th class="min-w-[110px]"><span class="sgh-table-col"><span class="sgh-table-col-label">{{ __('common.columns.submitted') }}</span></span></th>
